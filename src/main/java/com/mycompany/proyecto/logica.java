...
public class logica {
 ...
 private void IngresarDatos(){ //Metodo para ingresar datos con una condicional
  ...
  private void ClasificarDatos(){ //Metodo para clasificar los datos almacenados en la clase Producto y moverlos a otra clase
...
private void Movimientos(){ //Metodo de movimientos que me indica cuantos se han clasificado, cuantos se han ingresado
...
private void ConsultasModelo(){ //Void para hacer consultas por el nombre del modeo
...
private void ConsultasMarcas(){//Metodo para consultar por lista de marcas
...
private void MostrarEstado(){ //Metodo para Mostrar todos los productos que que este en estado dañado, perfecto y vacio
